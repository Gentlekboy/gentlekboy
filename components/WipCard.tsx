...
export default function WipCard({ project }: { project: Project }) {
  return (
    <div className="relative h-full rounded-[var(--radius-lg)] border border-dashed [border-color:var(--accent-border)] bg-bg-elevated/70 p-[var(--card-pad)] shadow-[0_0_12px_rgba(232,161,68,0.09)] transition-all duration-[var(--duration-base)] hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(232,161,68,0.16)]">
